  ...
  return (
    <div className="max-w-7xl mx-auto h-full">
      <div className="flex items-center flex-col h-full pt-[100px] px-5 ">
        ...
        />
        <div
          className={`mt-20 bg-background-muted/15 shadow-inner shadow-orange-300 border border-foreground/5   p-5 rounded-lg w-full  md:w-[500px] flex flex-col gap-5 text-foreground/60 ${mount ? "translate-y-0 opacity-100" : "translate-y-20 opacity-0"} transition-all duration-500 delay-200`}
        >
